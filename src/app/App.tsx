                    ...
                    element={
                      ...
                      >
                        <div className="app-card p-5">
                          ...
                          <div className="mt-6 rounded-2xl border border-dashed border-border bg-muted/40 p-8 text-center text-muted-foreground">
                      ...
                      >
                        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                          {[
                            ...
                            <div key={member.name} className="app-card p-5">
                      ...
                      >
                        <div className="app-card p-5">
                          ...
                          <div className="mt-6 grid gap-4 sm:grid-cols-2">
                            <button className="rounded-2xl border border-border p-4 text-left transition hover:border-[#BFCDBA] hover:bg-muted/40">
